module Mailboxer
  module Models
    module Messageable
      ...
      def reply(conversation, recipients, reply_body, subject=nil, sanitize_text=true, attachment=nil, action_type=nil)
        ...
        response.deliver(true, sanitize_text, action_type)
      end
      ...
      def reply_to_conversation(conversation, reply_body, subject=nil, should_untrash=true, sanitize_text=true, attachment=nil, action_type=nil)
        ...
        reply(conversation, conversation.last_message.recipients, reply_body, subject, sanitize_text, attachment, action_type)
      end
